...
import UpworkIcon from '$lib/components/icons/upwork.icon.svelte';
...
export const contacts: Array<Contect> = [
	...
	{ link: 'https://www.upwork.com/freelancers/~0184b429844e7f9abd', platform: 'Upwork', icon: UpworkIcon }
];
