    ...
    <>
      <section className="w-full gap-6 flex flex-col items-center relative md:items-start md:flex-row-reverse">
          ...
          <div className="flex flex-col h-full gap-3 md:flex-1 md:justify-center md:h-[620px]">
            ...
            <h1 className="text-3xl font-semibold text-center md:text-left md:text-5xl lg:text-[4.25rem] lg:leading-[4.5rem]">
            ...
            <p className="text-center md:text-left md:max-w-[90%] xl:max-w-[80%]">
              I develop software using modern stacks to create best product. I have more than 2 years of experience in
              web development and can work according to targets. Programming is my passion, and I am highly motivated to
              do it.
            </p>
